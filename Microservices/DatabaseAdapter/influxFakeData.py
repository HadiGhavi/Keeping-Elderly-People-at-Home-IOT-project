...
class HealthSensorGenerator:
    def __init__(self):
        ...
        self.current_health_state = 'healthy'
    ...
    def _update_health_state(self):
        ...
        if random.random() < self.state_change_probability:
            states = ['healthy', 'risky', 'dangerous']
    ...
    def _apply_health_state_effects(self, sensor_type, base_value):
        ...
        if self.current_health_state == 'healthy':
            return base_value
...
def main():
    ...
    HARDCODED_USERS = [
        {
            "user_chat_id": 8483019182,
            "full_name": "Mirella Bianchi",
            "sensors": [
                {"id": 1, "name": "temp"},
                {"id": 2, "name": "oxygen"},
